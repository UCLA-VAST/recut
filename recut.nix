...
in
  ...
  cmakeFlags = ["-DUSE_VDB=ON -DLOG=ON -DFULL_PRINT=OFF -DUSE_OMP_BLOCK=ON -DUSE_MCP3D=OFF -DTEST_ALL_BENCHMARKS=ON -DCMAKE_BUILD_TYPE=Debug -DCMAKE_MODULE_PATH=${openvdb}/lib/cmake/OpenVDB"];
