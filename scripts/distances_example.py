...
# in order to run navigate to TMD folder and run nix-shell so that all python dependencies are loaded
# then call this script changing the following paths as needed
...
validated = tmd.io.load_population("/home/kdmarrett/data/out/proofread")
recut = tmd.io.load_population("/home/kdmarrett/data/out/recut")
...
xlims, ylims = tmd.analysis.get_limits(phs_validated + phs_recut)
